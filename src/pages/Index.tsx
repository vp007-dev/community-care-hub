...
export default function Index() {
  return (
    <Layout>
      ...
      <section className="relative min-h-[90vh] overflow-hidden bg-mesh">
        {/* Floating Shapes */}
        <div className="absolute top-20 right-10 w-72 h-72 bg-gradient-to-br from-primary/20 to-amber-400/20 blob animate-float blur-3xl" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-gradient-to-tr from-teal/20 to-purple-400/20 blob animate-float-delayed blur-3xl" />
        
        <div className="container relative pt-12 pb-20 lg:pt-20 lg:pb-32">
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                <Button asChild size="lg" className="rounded-full px-8 h-14 text-base shine shadow-xl shadow-primary/25 hover:shadow-2xl hover:shadow-primary/30 transition-all">
                  <Link to="/support">
                    <Heart className="h-5 w-5 mr-2" />
                    Donate Now
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="rounded-full px-8 h-14 text-base group border-2">
                  <Link to="/about">
                    Our Story
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                {/* Logo Card */}
                <div className="col-span-2 p-6 rounded-3xl glass-strong border border-border/50 shadow-xl">
                  <div className="flex items-center gap-4">
                    <img src={logo} alt="VSF" className="w-16 h-16 rounded-2xl object-cover shadow-lg" />
                    <div>
                      <h3 className="font-bold text-lg text-foreground">Vidhya Swaroop</h3>
                ...
                {stats.slice(0, 2).map((stat, i) => (
                  <motion.div
                    ...
                    className="p-5 rounded-2xl glass border border-border/50 group hover:border-primary/30 transition-colors"
                  >
          ...
          >
            {programs.map((program, i) => (
              <motion.div key={program.title} variants={item}>
                <Link
                  to={program.link}
                  className={`group relative block h-full p-8 rounded-3xl bg-gradient-to-br ${program.bgGradient} border border-border/50 overflow-hidden card-hover`}
                >
                  ...
                  <div className="relative">
                    <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${program.gradient} flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
      ...
      <section className="py-20 bg-gradient-to-br from-foreground via-foreground to-foreground/95 relative overflow-hidden">
      ...
      <section className="py-24 relative overflow-hidden bg-mesh">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-br from-primary/30 via-amber-400/20 to-teal/30 rounded-full blur-3xl opacity-50" />
        ...
        <div className="container relative">
          ...
          >
            <div className="p-12 md:p-16 rounded-[2.5rem] glass-strong border border-border/50 text-center shadow-2xl">
              <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-br from-primary to-amber-500 flex items-center justify-center mb-8 shadow-xl">
